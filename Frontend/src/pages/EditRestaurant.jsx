...
import { fetchRestaurantById, updateRestaurant } from '../redux/slices/restaurantSlice';
...
const EditRestaurant = () => {
    ...
    // Set form data when restaurant data is loaded
    useEffect(() => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // Transform cuisines string to array
            ...
            const resultAction = await dispatch(updateRestaurant({ id, data: restaurantData }));
        ...
        <div className="container max-w-3xl mx-auto px-4 py-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
                <div className="flex items-center mb-6">
                    ...
                    <h1 className="text-2xl font-bold text-[#282C3F]">Edit Restaurant</h1>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex justify-end">
                        ...
                        <button
                            type="submit"
                            disabled={isSaving}
                            className={`px-4 py-2 bg-[#FC8019] text-white rounded-lg hover:bg-[#e07016] transition-colors duration-300 ${isSaving ? 'opacity-70 cursor-not-allowed' : ''
                                }`}
                        >
